...
export class PromocoesProvider {
  ...
  show(data:IListaPromocoes){
    return this.http.get<IListaPromocoes>('http://localhost:3000/promotions/'+data.id);
  }
  ...
  edit(data:IListaPromocoes){
    return this.http.put<IListaPromocoes>('http://localhost:3000/promotions/'+ data.id, data);
  }

  delete(data:IListaPromocoes){
    return this.http.delete<IListaPromocoes>('http://localhost:3000/promotions/'+ data.id);
  }
  /*all(){
